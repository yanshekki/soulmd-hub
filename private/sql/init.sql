...
CREATE TABLE IF NOT EXISTS souls (
    ...
    nft_salt VARCHAR(64) DEFAULT NULL COMMENT 'Cryptographic random salt generated by server',
    nft_hash VARCHAR(64) DEFAULT NULL COMMENT 'Authoritative finger-print hash(content + salt)',
