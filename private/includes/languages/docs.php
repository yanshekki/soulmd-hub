...
return [
    'en' => [
        ...
        'Usecase Automation Title' => '📡 Headless Cross-Origin Automation Routing',
        ...
        'Usecase Composable Title' => '🌿 Composable Dependency Trees & Repository Forking',
    ...
    'zh' => [
        ...
        // 4. Tab 3: Daily Use Cases (日常應用場景)
        // =========================================================
        'Production Workflows & Enterprise Automation' => '商業級生產工作流與企業自動化運轉',
        'UseCases Main Desc: SoulMD Hub transitions prompts from primitive hobbyist play-sandboxes into rigid enterprise-grade production architectures. By utilizing an infrastructure optimized for high-concurrency token routing and unredacted multi-file isolation, development crews and data analytic teams deploy specialized prompt nodes natively inside existing cross-origin operational loops.' => '跨域場景導言：SoulMD Hub 將傳統玩票性質的 AI 提示詞沙盒，升級為具備嚴格工業級強度的生產力架構。透過針對高併發 Token 路由優化的基礎設施與毫不妥協的多檔案模組隔離，工程團隊與數據分析小組能夠將定制的 Prompt 節點原生地嵌入到現有的跨網域（Cross-Origin）自動化執行鏈路中。',
        'Usecase Engineering Title' => '🛠️ 模組化極速代碼審查與 AST 語法樹分析',
