        ...
        <div class="xl:col-span-8 space-y-8">
            <div class="bg-zinc-900/60 border border-white/10 rounded-3xl p-6 md:p-8 backdrop-blur-sm shadow-xl">
                ...
                <div class="mb-10 border-l-2 border-zinc-800 pl-6">
                    ...
                    <p class="text-sm text-zinc-400 mb-2">Register a new user and generate an API key.</p>
                ...
                <div class="mb-10 border-l-2 border-zinc-800 pl-6">
                    ...
                    <p class="text-sm text-zinc-400 mb-2">Authenticate user. Returns API Key and sets web session if successful.</p>
                ...
                <div class="mb-10 border-l-2 border-zinc-800 pl-6">
                    ...
                    <p class="text-sm text-zinc-400 mb-2">Change the current user's password.</p>
                    <p class="text-xs text-zinc-500 font-mono">Body: {"current_password": "...", "new_password": "...", "confirm_password": "..."}</p>
                </div>

                <h3 class="text-xl font-bold text-emerald-400 mb-6 mt-12"><i class="fas fa-brain mr-2"></i> Core Souls</h3>
                ...
                <div class="mb-10 border-l-2 border-zinc-800 pl-6">
                    ...
                    <p class="text-sm text-zinc-400 mb-2">List and search public souls. Optimized for performance.</p>
                    <p class="text-xs text-zinc-500 font-mono">Query: ?limit=20&offset=0&q=ai&sort=popular&role=Developer</p>
                </div>
                ...
                <div class="mb-10 border-l-2 border-zinc-800 pl-6">
                    ...
                    <p class="text-sm text-zinc-400 mb-2">Retrieve details and raw content of a specific public soul.</p>
                </div>
                ...
                <div class="mb-10 border-l-2 border-zinc-800 pl-6">
                    ...
                    <p class="text-sm text-zinc-400 mb-2">Publish a new AI soul. Auto-detects single .md or Modular JSON folder.</p>
                    <p class="text-xs text-zinc-500 font-mono">Body: {"title": "...", "content": "...", "domain": "Tech"}</p>
                </div>
                ...
                <div class="mb-10 border-l-2 border-zinc-800 pl-6">
                    ...
                    <p class="text-sm text-zinc-400 mb-2">Update an existing soul. Automatically creates a version history backup.</p>
                    <p class="text-xs text-zinc-500 font-mono">Body: {"title": "...", "content": "...", "is_public": 1}</p>
                </div>
                ...
                <div class="mb-10 border-l-2 border-zinc-800 pl-6">
                    ...
                    <p class="text-sm text-zinc-400 mb-2">Permanently delete a soul and update tag statistics.</p>
                </div>

                <h3 class="text-xl font-bold text-emerald-400 mb-6 mt-12"><i class="fas fa-code-branch mr-2"></i> Versions & Interactions</h3>
                ...
                <div class="mb-10 border-l-2 border-zinc-800 pl-6">
                    ...
                    <p class="text-sm text-zinc-400 mb-2">Get all historical versions of a soul.</p>
                    <p class="text-xs text-zinc-500 font-mono">Query: ?soul_id={id}</p>
                </div>
                ...
                <div class="mb-10 border-l-2 border-zinc-800 pl-6">
                    ...
                    <p class="text-sm text-zinc-400 mb-2">Restore a soul to a specific historical version.</p>
                ...
                <div class="mb-10 border-l-2 border-zinc-800 pl-6">
                    ...
                    <p class="text-sm text-zinc-400 mb-2">Fork a public soul into your own account.</p>
