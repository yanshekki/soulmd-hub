...
$pageDesc = 'Manage your API key for SoulMD Hub public API.';
require_once __DIR__ . '/../private/includes/header.php';
?>

<div class="max-w-2xl mx-auto px-4 sm:px-6 py-12 w-full">
    ...
    <div class="bg-zinc-900 border border-white/10 rounded-3xl p-8">
        <div class="mb-6">
            <div class="flex justify-between items-center text-sm text-zinc-400 mb-3">
                ...
                <button onclick="copyKey()" class="flex items-center gap-1 text-emerald-400 hover:text-emerald-300 transition">
    ...
    <div class="mt-12 text-sm text-zinc-400">
        ...
        Add to your requests headers:<br>
