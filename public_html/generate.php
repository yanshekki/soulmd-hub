...
// 啟用 Session 以便將生成的資料帶到上傳頁面
session_start();

setSEO('AI Soul Generator', 'Describe your AI and instantly generate a professional SOUL.md.');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // 將生成的資料存入 Session，供 upload.php 預填
...
<body class="bg-zinc-950 text-white min-h-screen flex flex-col">
    <nav class="max-w-7xl w-full mx-auto px-4 sm:px-6 py-8 flex justify-between items-center mb-4">
    ...
    <div class="max-w-5xl w-full mx-auto px-4 sm:px-6 pb-16 flex-grow">
